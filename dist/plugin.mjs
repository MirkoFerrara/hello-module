...
var cl = function() {
  ...
  return i(e, "Observable"), e.prototype.lift = function(t) {
    ...
    var r = this;
    return n = Pp(n), new n(function(o, s) {
      var a = new ul({
    ...
    var n = this;
    return t = Pp(t), new t(function(r, o) {
      var s;
...
function Hw(e, t) {
  ...
  return function(r) {
    return r.pipe(e ? xw(function(o, s) {
      return e(o, s, r);
...
function hl(e, t = !1) {
  ...
  let n;
  typeof e == "function" || e instanceof $ ? n = e : n = P(e.provide);
  let r = e;
...
const oM = {}, Pi = oM, gl = "__NG_DI_FLAG__", _a = "ngTempTokenPath", iM = "ngTokenPath", sM = /\n/gm, aM = "ɵ", Bp = "__source";
let no;
function uM() {
  return no;
}
...
const xt = {}, Q = [];
(typeof ngDevMode > "u" || ngDevMode) && bd() && (Object.freeze(xt), Object.freeze(Q));
...
i(Pd, "internalImportProvidersFrom");
function Oy(e, t) {
  for (let n = 0; n < e.length; n++) {
...
function Fy(e, t, n) {
  if (hr(e) || vu(e) || ky(e) || Ny(e))
    return;
  P(e && (e.useClass || e.provide)) || pl(n, t, e);
}
i(Fy, "validateProvider");
function xd(e, t) {
  for (let n of e)
    cs(n) && (n = n.ɵproviders), Array.isArray(n) ? xd(n, t) : t(n);
}
i(xd, "deepForEachProvider");
...
class jo extends Lt {
  ...
  get(t, n = Pi, r = G.Default) {
    ...
    try {
      ...
      return n = r & G.Optional && n === Pi ? null : n, u.get(t, n);
    } catch (u) {
...
function Ry(e, t, n) {
  ...
  if (ngDevMode && cs(e) && pl(void 0, n, e), hr(e)) {
    ...
    r = /* @__PURE__ */ i(() => P(e.useValue), "factory");
  else if (ky(e))
    r = /* @__PURE__ */ i(() => e.useFactory(...ml(e.deps || [])), "factory");
  else if (Ny(e))
    r = /* @__PURE__ */ i(() => ke(P(e.useExisting)), "factory");
  else {
...
i(fi, "isType");
const xM = /^function\s+\S+\(\)\s*{[\s\S]+\.apply\(this,\s*(arguments|(?:[^()]+\(\[\],)?[^()]+\(arguments\).*)\)/, LM = /^class\s+[A-Za-z\d$_]*\s*extends\s+[^{]+{/, jM = /^class\s+[A-Za-z\d$_]*\s*extends\s+[^{]+{[\s\S]*constructor\s*\(/, $M = /^class\s+[A-Za-z\d$_]*\s*extends\s+[^{]+{[\s\S]*constructor\s*\(\)\s*{[^}]*super\(\.\.\.arguments\)/;
function BM(e) {
  return xM.test(e) || $M.test(e) || LM.test(e) && !jM.test(e);
}
i(BM, "isDelegateCtor");
class Ly {
  static {
...
function QM(e, t, n, r, o) {
  ...
  ngDevMode && xo(s, "Name of input in ngOnChanges has to be a string");
  const a = Zy(e) || ZM(e, { previous: xt, current: null }), u = a.current || (a.current = {}), c = a.previous, l = c[s];
  u[s] = new Gy(l && l.currentValue, n, c === xt), Wy(e, t, o, n);
}
...
const nf = Po("Attribute", (e) => ({ attributeName: e, __NG_ELEMENT_ID__: /* @__PURE__ */ i(() => _u(e), "__NG_ELEMENT_ID__") }));
let eg = null;
function rf() {
  return eg = eg || new Ly();
}
...
function F_(e, t) {
  ...
  e.hasOwnProperty(Ri) || Object.defineProperty(e, Ri, {
    get: /* @__PURE__ */ i(() => (n === null && (n = Oe({ usage: 0, kind: "injectable", type: e }).compileInjectable(Qp, `ng:///${e.name}/ɵprov.js`, P_(e, t))), n), "get")
...
i(PD, "unwrapElementRef");
class U_ extends Ni {
  static {
    i(this, "EventEmitter_");
  }
  constructor(t = !1) {
    super(), this.destroyRef = void 0, this.__isAsync = t, Py() && (this.destroyRef = M(Hr, { optional: !0 }) ?? void 0);
  }
  emit(t) {
    const n = B(null);
    try {
...
i(xD, "hasSkipHydrationAttrOnTNode");
function LD(e) {
...
i(Pa, "hasInSkipHydrationBlockFlag");
function xa(e) {
  if (Pa(e))
    return !0;
  let t = e.parent;
...
const Nl = "e", kl = "t", zi = "c", ja = "x", vo = "r", Rl = "i", Pl = "n", ma = "d", mS = "__nghData__", hf = mS, vi = "ngh", rv = "nghm";
...
i(Pu, "createElementNode");
function vT(e, t) {
  Pv(e, t), t[fe] = null, t[Be] = null;
}
...
function Wi(e, t) {
  ...
  if (r) {
    const o = r[gs];
    o !== null && o !== e && xv(o, r), t > 0 && (e[n - 1][kt] = r[kt]);
    const s = Sa(e, me + t);
    vT(r[E], r);
    const a = s[Rt];
...
function qv(e, t, n, r, o, s) {
  ...
  if (Array.isArray(c))
    ...
    let l = c;
    const d = a[Ee];
    Pa(r) && (l.flags |= 128), Af(e, t, l, d, o, s, !0);
  }
}
...
function Yv(e = 1) {
  ngDevMode && tr(e, 0, "Can only advance forward"), Kv(x(), y(), Ve() + e, !!ngDevMode && Br());
}
i(Yv, "ɵɵadvance");
function Kv(e, t, n, r) {
...
i(PT, "enableApplyRootElementTransformImpl");
function xT(e, t, n, r) {
  const o = uI(t);
...
function oI(e, t, n, r, o, s) {
  ...
  for (let l = 0; l < r.length; l++) {
    const d = r[l];
    n.mergedAttrs = xi(n.mergedAttrs, d.hostAttrs), YT(e, n, t, c, d), QT(c, d, o), d.contentQueries !== null && (n.flags |= 4), (d.hostBindings !== null || d.hostAttrs !== null || d.hostVars !== 0) && (n.flags |= 64);
...
function an(e, t, n, r, o, s) {
  ...
  const a = He(e, t);
  xf(t[N], a, s, e.value, n, r, o);
}
i(an, "elementAttributeInternal");
function xf(e, t, n, r, o, s, a) {
  if (s == null)
...
function Tn(e, t, n) {
  ngDevMode && xo(n, "Value should be a string"), ngDevMode && $r(n, F, "value should not be NO_CHANGE"), ngDevMode && be(e, t);
  const r = ys(t, e);
...
function bo(e, t) {
  return !t || t.firstChild === null || Pa(e);
}
...
class wo {
  ...
  detachFromAppRef() {
    this._appRef = null, Pv(this._lView[E], this._lView);
  }
  attachToAppRef(t) {
...
i(xA, "locateDehydratedViewsInContainer");
...
const Er = new JA();
function Va(e, t, n) {
  ngDevMode && st(x(), "Expecting to be called in first template pass only");
...
class Yo extends Ba {
  ...
  create(t, n, r, o) {
    ...
    try {
      ...
      }, p = c.createRenderer(null, this.componentDef), g = this.componentDef.selectors[0][0] || "div", m = r ? NT(p, r, this.componentDef.encapsulation, u) : Pu(p, g, XA(g));
      let v = 512;
...
const a1 = Fe, FI = class extends a1 {
  ...
  remove(t) {
    ...
    r && (Sa(Rc(this._lContainer), n), xu(r[E], r));
  }
  detach(t) {
    const n = this._adjustIndex(t, -1), r = Wi(this._lContainer, n);
...
let kI = PI, zf = /* @__PURE__ */ i(() => !1, "_populateDehydratedViewsInLContainer");
function RI(e, t, n) {
  return zf(e, t, n);
}
...
function jI(e, t, n) {
  ...
  return xT(e, t, r, r.destroy), (t[Rt] ??= new Wf()).queries.push(new Gf(r)) - 1;
}
i(jI, "createLQuery");
function $I(e, t, n) {
  ngDevMode && X(t, "Expecting flags");
  const r = x();
  return r.firstCreatePass && (HI(r, new xI(e, t, n), -1), (t & 2) === 2 && (r.staticViewQueries = !0)), jI(r, y(), t);
}
i($I, "createViewQuery");
function BI(e, t, n, r) {
  ...
  if (o.firstCreatePass) {
    const s = J();
    HI(o, new xI(t, n, r), s.index), y1(o, e), (n & 2) === 2 && (o.staticContentQueries = !0);
  }
  return jI(o, y(), n);
}
...
function v1(e, t) {
  ...
  return o.reset(s, PD), t ? o.first : o._changesDetected || e._flatValue === void 0 ? e._flatValue = o.toArray() : e._flatValue;
}
  ...
  for (; t; ) {
    ...
    if (o) {
      if (n) {
        ...
        if (c && L1(e, c), l && j1(e, l), P1(e, o), Gw(e.outputs, o.outputs), wt(o) && o.data.animation) {
          const d = e.data;
...
i(P1, "mergeInputsWithTransforms");
function x1(e) {
  let t = 0, n = null;
...
i(x1, "mergeHostAttrsAcrossInheritance");
function Qs(e) {
  return e === xt ? {} : e === Q ? [] : e;
}
...
function cC(e) {
  const t = /* @__PURE__ */ i((n) => {
    const r = (Array.isArray(e) ? e : e()).map((o) => typeof o == "function" ? { directive: P(o), inputs: xt, outputs: xt } : {
      directive: P(o.directive),
      inputs: Rg(o.inputs),
...
function U1(e, t) {
  ...
  Pg("input", t, e.inputs), Pg("output", t, e.outputs);
}
...
class Pt {
  ...
  static {
    this.ɵprov = /* @__PURE__ */ ne({ token: Pt, factory: Pt.ɵfac, providedIn: "root" });
  }
}
(typeof ngDevMode > "u" || ngDevMode) && Xe(Pt, [{
  type: he,
...
function So(e, t, n, r, o, s, a, u) {
  const c = y(), l = x(), d = e + A, f = l.firstCreatePass ? Y1(d, l, c, t, n, r, o, s, a) : l.data[d];
  en(f, !1);
  const h = pC(l, c, f, e);
...
function K1(e, t, n, r) {
  const o = t[mt], s = !o || Ho() || Ps(n) || Ou(o, r);
  if (rn(s), s)
    return gC(e, t);
...
const oo = 0, xs = 1, pi = 2, Zs = 3, mC = 4, yC = 5;
var Ga;
(function(e) {
...
function ed(e, t) {
  return t === ge.Placeholder ? e.placeholderBlockConfig?.[xg] ?? null : t === ge.Loading ? e.loadingBlockConfig?.[xg] ?? null : null;
}
...
const Wa = {
  passive: !0,
  capture: !0
}, Pc = /* @__PURE__ */ new WeakMap(), xc = /* @__PURE__ */ new WeakMap(), Gr = /* @__PURE__ */ new WeakMap(), jg = ["click", "keydown"], $g = ["mouseenter", "focusin"];
let Wr = null, Lc = 0;
class ah {
  static {
  ...
  return u ? (e.loadingPromise = Promise.allSettled(u()).then((d) => {
    ...
    if (e.loadingPromise = null, c.remove(l), f) {
      ...
      if (h.length > 0) {
        ...
        const m = h.map((C) => C.type), v = Pd(!1, ...m);
        e.providers = v;
      }
...
function lh(e, t, n, r, o, s) {
  ...
  if (u !== F) {
    const c = ce();
    an(c, a, e, u, o, s), ngDevMode && Ie(x().data, c, "attr." + e, ee() - 1, t, r);
  }
  return lh;
}
...
function dh(e, t, n, r, o, s, a, u) {
  ...
  if (l !== F) {
    const d = ce();
    an(d, c, e, l, a, u), ngDevMode && Ie(x().data, d, "attr." + e, ee() - 2, t, r, s);
  }
  return dh;
}
...
function fh(e, t, n, r, o, s, a, u, c, l) {
  ...
  if (f !== F) {
    const h = ce();
    an(h, d, e, f, c, l), ngDevMode && Ie(x().data, h, "attr." + e, ee() - 3, t, r, s, u);
  }
  return fh;
}
...
function hh(e, t, n, r, o, s, a, u, c, l, d, f) {
  ...
  if (p !== F) {
    const g = ce();
    an(g, h, e, p, d, f), ngDevMode && Ie(x().data, g, "attr." + e, ee() - 4, t, r, s, u, l);
  }
  return hh;
}
...
function ph(e, t, n, r, o, s, a, u, c, l, d, f, h, p) {
  ...
  if (m !== F) {
    const v = ce();
    an(v, g, e, m, h, p), ngDevMode && Ie(x().data, v, "attr." + e, ee() - 5, t, r, s, u, l, f);
  }
  return ph;
}
...
function gh(e, t, n, r, o, s, a, u, c, l, d, f, h, p, g, m) {
  ...
  if (C !== F) {
    const D = ce();
    an(D, v, e, C, g, m), ngDevMode && Ie(x().data, D, "attr." + e, ee() - 6, t, r, s, u, l, f, p);
  }
  return gh;
}
...
function mh(e, t, n, r, o, s, a, u, c, l, d, f, h, p, g, m, v, C) {
  ...
  if (_ !== F) {
    const R = ce();
    an(R, D, e, _, v, C), ngDevMode && Ie(x().data, R, "attr." + e, ee() - 7, t, r, s, u, l, f, p, m);
  }
  return mh;
}
...
function yh(e, t, n, r, o, s, a, u, c, l, d, f, h, p, g, m, v, C, D, _) {
  ...
  if (W !== F) {
    const le = ce();
    an(le, R, e, W, D, _), ngDevMode && Ie(x().data, le, "attr." + e, ee() - 8, t, r, s, u, l, f, p, m, C);
  }
  return yh;
}
  ...
  if (s !== F) {
    ...
    if (an(a, o, e, s, n, r), ngDevMode) {
      ...
      for (let c = 2; c < t.length; c += 2)
        u.push(t[c]);
      Ie(x().data, a, "attr." + e, ee() - u.length + 1, ...u);
    }
  }
  return Dh;
}
...
class LO extends kO {
  ...
  create(t, n) {
    ...
    return Ss(this.hostLView, this.templateTNode, new PO(this.lContainer, n, t), { dehydratedView: r });
  }
  destroy(t) {
    xu(t[E], t);
  }
...
function BO(e, t, n, r, o, s) {
  ...
  return Pf(t, n, c, Xt(a, s)), c.attrs !== null && Va(c, c.attrs, !1), c.mergedAttrs !== null && Va(c, c.mergedAttrs, !0), t.queries !== null && t.queries.elementStart(t, c), c;
}
...
function ic(e, t, n, r) {
  ...
  o[a] = l;
  const d = Cu(c);
  return ngDevMode && s.firstCreatePass && fT(l, o, c.value, s.schemas, d), en(c, !0), Zv(u, l, c), !Ps(c) && Is() && ju(s, o, l, c), t_() === 0 && Le(l, o), n_(), d && (Nf(s, o, c), Ff(s, c, o)), r !== null && kf(o, c), ic;
}
i(ic, "ɵɵelementStart");
function sc() {
  let e = J();
...
i(Eh, "ɵɵelement");
let IE = /* @__PURE__ */ i((e, t, n, r, o, s) => (rn(!0), Pu(r, o, vD())), "_locateOrCreateElementNode");
function HO(e, t, n, r, o, s) {
  const a = t[mt], u = !a || Ho() || Ps(n) || Ou(a, s);
  if (rn(u), u)
    return Pu(r, o, vD());
  const c = Qu(a, e, t, n);
  if (ngDevMode && Os(c, Node.ELEMENT_NODE, o, t, n), ngDevMode && Go(c), uv(a, s) && (ngDevMode && Wu(c.nextSibling, t, n), Au(a, s, c.nextSibling)), a && (xD(n) || LD(c))) {
    if (nr(n))
...
function UO(e, t, n, r, o) {
  ...
  a !== null && Va(u, a, !0);
  const c = Xt(s, o);
  return Pf(t, n, u, c), t.queries !== null && t.queries.elementStart(t, u), u;
}
...
function Mh(e, t, n) {
  const r = y(), o = Bt();
  if (we(r, o, t)) {
    const s = x(), a = ce(), u = Kd(s.data), c = cI(u, a, r);
    ...
    if (typeof c == "string") {
      ...
      switch (c & 1) {
        ...
        case 1:
          ...
          xf(o, ys(h, n), null, null, p, g, null);
          break;
        default:
          if (ngDevMode)
          ...
          if (d < 0)
            ...
            switch (d & 3) {
              case 1:
                ...
                ngDevMode && b(g, "Experting TNode or string"), typeof g == "string" ? xf(t[N], t[f], null, g, h, c, p) : at(e, g, t, h, c, t[N], p, !1);
                break;
              case 0:
                const m = t[f];
                m !== null && Rv(t[N], m, c);
...
const Ka = /�(\d+):?\d*�/gi, IF = /({\s*�\d+:?\d*�\s*,\s*\S{6}\s*,[\s\S]*})/gi, CF = /�(\d+)�/, PE = /^\s*(�\d+:?\d*�)\s*,\s*(select|plural)\s*,/, _i = "�", EF = /�\/?\*(\d+:\d+)�/gi, bF = /�(\/?[#*]\d+):?\d*�/gi, wF = /\uE500/g;
function MF(e) {
  return e.replace(wF, " ");
}
i(MF, "replaceNgsp");
    ...
    if (h & 1) {
      ...
      for (let m = 0; m < g.length; m++) {
        ...
        if (m & 1) {
          ...
          const _ = xE(e, a, l[0], n, u, ngDevMode ? `ICU ${r}:${C.mainBinding}` : "", !0).index;
          ngDevMode && wn(_, A, "Index must be in absolute LView offset"), jE(d[0], e, n, c, t, C, _);
        } else {
          const C = v;
          ngDevMode && xo(C, "Parsed ICU part should be string"), C !== "" && SF(d[0], e, a, l[0], u, c, n, C);
        }
      }
    }
  }
...
i(xE, "createTNodeAndAddOpCode");
function SF(e, t, n, r, o, s, a, u) {
  const c = u.match(Ka), d = xE(t, n, r, a, o, c ? null : u, !1).index;
  ...
  for (; s = o.exec(e); ) {
    ...
    if (s[0] == "}") {
      if (n.pop(), n.length == 0) {
        ...
        PE.test(c) ? r.push(NF(c)) : r.push(c), t = u + 1;
      }
    } else {
      if (n.length == 0) {
        const c = e.substring(t, u);
...
i(Fh, "ɵɵlistener");
function Nh(e, t) {
  const n = J(), r = y(), o = x(), s = Kd(o.data), a = cI(s, n, r);
...
function WE(e, t = 0, n) {
  const r = y(), o = x(), s = Qo(o, A + e, 16, null, n || null);
...
i(Ph, "ɵɵpropertyInterpolate2");
function xh(e, t, n, r, o, s, a, u, c) {
...
function ZE(e) {
  ...
  if (e.dirty && vs(t) === ((o.metadata.flags & 2) === 2)) {
    if (o.matches === null)
      ...
      const s = VI(t, r);
      e.reset(s, PD), e.notifyOnChanges();
    }
    return !0;
  }
  return !1;
...
function ZF(e, t, n, r, o) {
  const s = t[mt], a = !s || Ho() || Ps(n) || Ou(s, o);
  if (rn(a), a)
    return _f(t[N], r);
  const u = Qu(s, e, t, n);
...
function Vc(e, t, n, r) {
  const o = hr(t), s = OM(t);
  if (o || s) {
    const c = (s ? P(t.useClass) : t).prototype.ngOnDestroy;
    if (c) {
...
class Ja {
  ...
  getOrCreateStandaloneInjector(t) {
    if (!t.standalone)
      return null;
    if (!this.cachedInjectors.has(t)) {
      const n = Pd(!1, t.type), r = n.length > 0 ? oh([n], this._injector, `Standalone[${t.type.name}]`) : null;
...
function Ks(e) {
  if (typeof e == "function")
    return e;
  const t = nt(e);
  return t.some(hu) ? () => t.map(P).map(om) : t.map(om);
}
...
function z0(e) {
  return Array.isArray(e) ? e.every(z0) : !!P(e);
}
    ...
    get: /* @__PURE__ */ i(() => {
      if (o === null) {
        ...
        o = Oe({ usage: 0, kind: "NgModule", type: e }).compileNgModule(Qe, `ng:///${e.name}/ɵmod.js`, {
          type: e,
          bootstrap: nt(t.bootstrap || Q).map(P),
          declarations: r.map(P),
          imports: nt(t.imports || Q).map(P).map(sm),
          exports: nt(t.exports || Q).map(P).map(sm),
...
`));
  function d(D) {
    D = P(D), U(D) || Ne(D) || ft(D) || o.push(`Unexpected value '${z(D)}' declared by the module '${z(e)}'. Please add a @Pipe/@Directive/@Component annotation.`);
  }
  ...
  function h(D, _) {
    if (D = P(D), (U(D) || Ne(D) || ft(D))?.standalone) {
  ...
  function m(D) {
    D = P(D), !va.get(D) && !Fn(D) && o.push(`Component ${z(D)} is not part of any NgModule or the module has not been imported into your module.`);
  }
  i(m, "verifyComponentIsPartOfNgModule");
  function v(D) {
    D = P(D), U(D) || o.push(`${z(D)} cannot be used as an entry component.`), Fn(D) && o.push(`The \`${z(D)}\` class is a standalone component, which can not be used in the \`@NgModule.bootstrap\` array. Use the \`bootstrapApplication\` function for bootstrap instead.`);
  }
...
`));
        ...
        try {
          if (c.usesInheritance && X0(e), n = r.compileComponent(Qe, u, c), t.standalone) {
            ...
            n.directiveDefs = d, n.pipeDefs = f, n.dependencies = () => l.map(P);
          }
        } finally {
          Gc--;
        }
...
function pN(e) {
  return typeof e == "string" ? rb(e) : P(e);
}
...
function RN(e, t) {
  ...
  const r = PN(t, e), o = ab(e), s = r.map((a) => {
    const u = {
      value: a.value
    }, c = a.flags;
    u.flags = {
...
i(PN, "getDependenciesForTokenInInjector");
function xN(e) {
...
i(xN, "getProviderImportsContainer");
function LN(e) {
...
class ot {
  ...
  bootstrap(t, n) {
    ...
    const a = hb(s) ? void 0 : this._injector.get(Xn), u = n || s.selector, c = s.create(Pe.NULL, [], u, a), l = c.location.nativeElement, d = c.injector.get(ub, null);
...
function Ib(e, t, n) {
  ...
  const a = Oe({
    ...
    kind: "NgModule",
    type: n
  }), c = Pe.create({ providers: s }).get(a.ResourceLoader);
...
class co {
  ...
  constructor() {
    this.subscription = new Ro(), this.initialized = !1, this.zone = M(de), this.pendingTasks = M(Pt);
  }
  initialize() {
    if (this.initialized)
      return;
...
function Sb(e = [], t) {
  return Pe.create({
    ...
    providers: [
      ...
      { provide: vp, useValue: /* @__PURE__ */ new Set([() => Pn = null]) },
      ...e
    ]
  });
}
...
const Ck = [new Pb()], Ek = [new kb()], bk = new Ot(Ek), wk = new dt(Ck), Mk = _b(null, "core", []);
class Xi {
  static {
...
class fo {
  ...
  constructor() {
    this.appRef = M(ot), this.taskService = M(Pt), this.pendingRenderTaskId = null, this.shouldRefreshViews = !1;
  }
  notify(t = 0) {
...
const Nk = 1e4;
function kk() {
  vm || (vm = !0, DS(), VO(), YF(), GO(), J1(), d1(), jA(), PT(), fF());
}
...
function xk() {
  return ps([
    ...
    },
    {
      provide: dr,
      useValue: /* @__PURE__ */ i(() => {
        xb = !!M(dv, { optional: !0 }), Nt() && M(hi) && (Bk(), kk());
      }, "useValue"),
      multi: !0
    },
    {
    ...
    if (y_(s)) {
      ...
      if (Array.isArray(s.projection)) {
        for (const u of s.projection)
          if (u)
            if (!Array.isArray(u))
              !HM(u) && !xa(u) && (Zi(u, e) ? Im(n, u) : eu(n, u, e));
            else
              throw DA(oe(e[o]));
      }
      if (Wk(n, s, e), Re(e[o])) {
...
i(Hb, "serializeLView");
function Wk(e, t, n) {
  t.projectionNext && t.projectionNext !== t.next && !xa(t.projectionNext) && eu(e, t.projectionNext, n), t.prev === null && t.parent !== null && Zi(t.parent, n) && !Zi(t, n) && eu(e, t, n);
}
...
function Vb(e, t) {
  !t && Ye(Vb);
  const n = t?.injector ?? M(Pe), r = n.get(ot);
  let o = !1;
  const s = /* @__PURE__ */ i(() => {
    o || r.destroyed || (o = !0, e());
  }, "runCallbackOnce");
...
class eR {
  ...
  constructor() {
    this.queuedEffectCount = 0, this.queues = /* @__PURE__ */ new Map(), this.pendingTasks = M(Pt), this.taskId = null;
  }
  scheduleEffect(t) {
...
function md(e, t) {
  ...
  const n = t?.injector ?? M(Pe), r = t?.manualCleanup !== !0 ? n.get(Hr) : null, o = new tR(n.get(Xk), e, typeof Zone > "u" ? null : Zone.current, r, n, t?.allowSignalWrites ?? !1), s = n.get(ci, null, { optional: !0 });
...
i(wR, "getDatePart");
function ue(e, t, n = xe.Format, r = !1) {
  return function(o, s) {
...
function TR(e) {
  ...
  switch (e) {
    ...
    case "MMMMM":
      ...
      break;
    case "LLL":
      t = ue(Y.Months, re.Abbreviated, xe.Standalone);
      break;
    case "LLLL":
      t = ue(Y.Months, re.Wide, xe.Standalone);
      break;
    case "LLLLL":
      t = ue(Y.Months, re.Narrow, xe.Standalone);
      break;
    case "w":
      t = Yc(1);
      break;
    ...
    case "cc":
      ...
      break;
    case "ccc":
      t = ue(Y.Days, re.Abbreviated, xe.Standalone);
      break;
    case "cccc":
      t = ue(Y.Days, re.Wide, xe.Standalone);
      break;
    case "ccccc":
      t = ue(Y.Days, re.Narrow, xe.Standalone);
      break;
    case "cccccc":
      t = ue(Y.Days, re.Short, xe.Standalone);
      break;
    case "E":
    case "EE":
    case "EEE":
    ...
    case "bb":
    case "bbb":
      t = ue(Y.DayPeriods, re.Abbreviated, xe.Standalone, !0);
      break;
    case "bbbb":
      t = ue(Y.DayPeriods, re.Wide, xe.Standalone, !0);
      break;
    case "bbbbb":
      t = ue(Y.DayPeriods, re.Narrow, xe.Standalone, !0);
      break;
    case "B":
    case "BB":
    case "BBB":
      t = ue(Y.DayPeriods, re.Abbreviated, xe.Format, !0);
      break;
    case "BBBB":
      t = ue(Y.DayPeriods, re.Wide, xe.Format, !0);
      break;
    case "BBBBB":
      t = ue(Y.DayPeriods, re.Narrow, xe.Format, !0);
      break;
    case "h":
      t = Me(K.Hours, 1, -12);
      break;
...
i(wm, "isDate");
const kR = /^(\d+)?\.((\d+)(-(\d+))?)?$/, Mm = 22, iu = ".", Ai = "0", RR = ";", PR = ",", Jc = "#", _m = "¤", xR = "%";
...
function jR(e, t, n) {
  ...
  return Mp(e, o, t, _e.Group, _e.Decimal, n, !0).replace(new RegExp(xR, "g"), Et(t, _e.PercentSign));
}
i(jR, "formatPercent");
function $R(e, t, n) {
...
class Pr {
  ...
  static {
    this.ɵfac = V({ minVersion: "12.0.0", version: "17.3.12", ngImport: w, type: Pr, deps: [{ token: Fe }], target: L.Directive });
  }
  static {
    this.ɵdir = It({ minVersion: "14.0.0", version: "17.3.12", type: Pr, isStandalone: !0, selector: "[ngTemplateOutlet]", inputs: { ngTemplateOutletContext: "ngTemplateOutletContext", ngTemplateOutlet: "ngTemplateOutlet", ngTemplateOutletInjector: "ngTemplateOutletInjector" }, usesOnChanges: !0, ngImport: w });
  }
}
...
class xr {
  ...
  static {
    this.ɵfac = V({ minVersion: "12.0.0", version: "17.3.12", ngImport: w, type: xr, deps: [], target: L.Pipe });
  }
  static {
    this.ɵpipe = lt({ minVersion: "14.0.0", version: "17.3.12", ngImport: w, type: xr, isStandalone: !0, name: "json", pure: !1 });
  }
}
...
class po {
  ...
  static {
    this.ɵmod = zb({ minVersion: "14.0.0", version: "17.3.12", ngImport: w, type: po, imports: [Sr, Tr, Ar, Or, Pr, Rr, jt, Fr, Nr, bn, kr, jn, Hn, $n, xr, Qn, Gn, Wn, Bn, qn, Vn, Un, zn, Lr], exports: [Sr, Tr, Ar, Or, Pr, Rr, jt, Fr, Nr, bn, kr, jn, Hn, $n, xr, Qn, Gn, Wn, Bn, qn, Vn, Un, zn, Lr] });
  }
  static {
...
const eP = "browser", tP = "server";
function nP(e) {
  return e === eP;
}
i(nP, "isPlatformBrowser");
function rP(e) {
  return e === tP;
}
i(rP, "isPlatformServer");
new hp("17.3.12");
class ew {
  static {
  ...
  static {
    this.ɵprov = ne({
      token: ew,
      providedIn: "root",
      factory: /* @__PURE__ */ i(() => nP(M(Es)) ? new oP(M(li), window) : new sP(), "factory")
    });
  }
}
class oP {
...
function Ic(e, t) {
  return /* @__PURE__ */ i(function(r) {
    return aP(r) || lP(r, t || []), r = uP(r), [{ provide: tw, useValue: /* @__PURE__ */ i((a) => (Fp(a.src) && dP(r, a.src), e(r, { ...a, src: cP(a.src) })), "loaderFn") }];
  }, "provideImageLoader");
}
...
i(dP, "throwUnexpectedAbsoluteUrlError");
Ic(fP, ngDevMode ? ["https://<ZONE>/cdn-cgi/image/<OPTIONS>/<SOURCE-IMAGE>"] : void 0);
function fP(e, t) {
  let n = "format=auto";
  return t.width && (n += `,width=${t.width}`), t.isPlaceholder && (n += `,quality=${Op}`), `${e}/cdn-cgi/image/${n}/${t.src}`;
}
i(fP, "createCloudflareUrl");
const hP = {
  name: "Cloudinary",
  testUrl: gP
}, pP = /https?\:\/\/[^\/]+\.cloudinary\.com\/.+/;
function gP(e) {
  return pP.test(e);
}
i(gP, "isCloudinaryUrl");
Ic(mP, ngDevMode ? [
...
i(mP, "createCloudinaryUrl");
const yP = {
  name: "ImageKit",
  testUrl: vP
}, DP = /https?\:\/\/[^\/]+\.imagekit\.io\/.+/;
function vP(e) {
  return DP.test(e);
}
i(vP, "isImageKitUrl");
Ic(IP, ngDevMode ? ["https://ik.imagekit.io/mysite", "https://subdomain.mysite.com"] : void 0);
function IP(e, t) {
...
i(bP, "isImgixUrl");
Ic(wP, ngDevMode ? ["https://somepath.imgix.net/"] : void 0);
function wP(e, t) {
...
class ns {
  ...
  initPerformanceObserver() {
    const t = new PerformanceObserver((n) => {
      ...
      a && (!a.priority && !a.alreadyWarnedPriority && (a.alreadyWarnedPriority = !0, TP(s)), a.modified && !a.alreadyWarnedModified && (a.alreadyWarnedModified = !0, AP(s)));
    });
    return t.observe({ type: "largest-contentful-paint", buffered: !0 }), t;
  }
  registerImage(t, n, r) {
...
i(AP, "logModifiedWarning");
const OP = /* @__PURE__ */ new Set(["localhost", "127.0.0.1", "0.0.0.0"]), FP = new $(ngDevMode ? "PRECONNECT_CHECK_BLOCKLIST" : "");
class rs {
  static {
    i(this, "PreconnectLinkChecker");
  }
  constructor() {
    this.document = M(li), this.preconnectLinks = null, this.alreadySeen = /* @__PURE__ */ new Set(), this.window = null, this.blocklist = new Set(OP), nw("preconnect link checker");
    const t = this.document.defaultView;
    typeof t < "u" && (this.window = t);
    const n = M(FP, { optional: !0 });
    n && this.populateBlocklist(n);
  }
  populateBlocklist(t) {
    Array.isArray(t) ? rw(t, (n) => {
      this.blocklist.add(Pm(n));
    }) : this.blocklist.add(Pm(t));
  }
  /**
...
i(rw, "deepForEach");
const xm = 5, NP = new $("NG_OPTIMIZED_PRELOADED_IMAGES", {
  providedIn: "root",
...
class os {
  ...
  constructor() {
    this.preloadedImages = M(NP), this.document = M(li);
  }
  /**
  ...
  createPreloadLinkTag(t, n, r, o) {
    if (ngDevMode && this.preloadedImages.size >= xm)
      throw new I(2961, ngDevMode && `The \`NgOptimizedImage\` directive has detected that more than ${xm} images were marked as priority. This might negatively affect an overall performance of the page. To fix this, remove the "priority" attribute from images with less priority.`);
...
const Lm = 50, ow = /^((\s*\d+w\s*(,|$)){1,})$/, kP = /^((\s*\d+(\.\d+)?x\s*(,|$)){1,})$/, tl = 3, Oi = 2, RP = [1, 2], PP = 640, jm = 0.1, $m = 1e3, xP = 1920, LP = 1080, jP = 15, Bm = 4e3, Hm = 1e4, $P = [
  CP,
  yP,
  hP,
  MP
...
class su {
  ...
  constructor() {
    this.imageLoader = M(tw), this.config = BP(M(lf)), this.renderer = M(Zo), this.imgElement = M(on).nativeElement, this.injector = M(Pe), this.isServer = rP(M(Es)), this.preloadLinkCreator = M(os), this.lcpObserver = ngDevMode ? this.injector.get(ns) : null, this._renderedSrc = null, this.priority = !1, this.disableOptimizedSrcset = !1, this.fill = !1;
  }
  /** @nodoc */
  ngOnInit() {
    if (St("NgOptimizedImage"), ngDevMode) {
      const t = this.injector.get(de);
      iw(this, "ngSrc", this.ngSrc), YP(this, this.ngSrcset), HP(this), this.ngSrcset && VP(this), UP(this), ZP(this), this.fill ? (nx(this), t.runOutsideAngular(() => rx(this, this.imgElement, this.renderer))) : (tx(this), this.height !== void 0 && Vm(this, this.height, "height"), this.width !== void 0 && Vm(this, this.width, "width"), t.runOutsideAngular(() => ex(this, this.imgElement, this.renderer))), ox(this), this.ngSrcset || zP(this), GP(this, this.imageLoader), ix(this.ngSrc, this.imageLoader), sx(this, this.imageLoader), ax(this, this.imageLoader), this.lcpObserver !== null && this.injector.get(de).runOutsideAngular(() => {
  ...
  getResponsiveSrcset() {
    ...
    let n = t;
    return this.sizes?.trim() === "100vw" && (n = t.filter((o) => o >= PP)), n.map((o) => `${this.callImageLoader({ src: this.ngSrc, width: o })} ${o}w`).join(", ");
  }
  ...
  getFixedSrcset() {
    return RP.map((n) => `${this.callImageLoader({
      src: this.ngSrc,
      width: this.width * n
    })} ${n}x`).join(", ");
  }
  shouldGenerateAutomaticSrcset() {
    let t = !1;
    return this.sizes || (t = this.width > xP || this.height > LP), !this.disableOptimizedSrcset && !this.srcset && this.imageLoader !== di && !t;
  }
  /**
  ...
  static {
    this.ɵdir = It({ minVersion: "16.1.0", version: "17.3.12", type: su, isStandalone: !0, selector: "img[ngSrc]", inputs: { ngSrc: ["ngSrc", "ngSrc", sw], ngSrcset: "ngSrcset", sizes: "sizes", width: ["width", "width", es], height: ["height", "height", es], loading: "loading", priority: ["priority", "priority", xn], loaderParams: "loaderParams", disableOptimizedSrcset: ["disableOptimizedSrcset", "disableOptimizedSrcset", xn], fill: ["fill", "fill", xn], placeholder: ["placeholder", "placeholder", aw], placeholderConfig: "placeholderConfig", src: "src", srcset: "srcset" }, host: { properties: { "style.position": 'fill ? "absolute" : null', "style.width": 'fill ? "100%" : null', "style.height": 'fill ? "100%" : null', "style.inset": 'fill ? "0" : null', "style.background-size": 'placeholder ? "cover" : null', "style.background-position": 'placeholder ? "50% 50%" : null', "style.background-repeat": 'placeholder ? "no-repeat" : null', "style.background-image": "placeholder ? generatePlaceholder(placeholder) : null", "style.filter": 'placeholder && shouldBlurPlaceholder(placeholderConfig) ? "blur(15px)" : null' } }, usesOnChanges: !0, ngImport: w });
  }
}
H({ type: su, decorators: [{
  ...
  args: [{
    ...
    host: {
      ...
      "[style.filter]": `placeholder && shouldBlurPlaceholder(placeholderConfig) ? "blur(${jP}px)" : null`
    }
  }]
...
i(VP, "assertNoConflictingSrcset");
function UP(e) {
  let t = e.ngSrc.trim();
...
i(zP, "assertNoComplexSizes");
function GP(e, t) {
  WP(e), qP(e, t), QP(e);
}
i(GP, "assertValidPlaceholder");
function WP(e) {
...
i(WP, "assertNoPlaceholderConfigWithoutPlaceholder");
function qP(e, t) {
...
i(qP, "assertNoRelativePlaceholderWithoutLoader");
function QP(e) {
...
function YP(e, t) {
  if (t == null)
    return;
  iw(e, "ngSrcset", t);
  const n = t, r = ow.test(n), o = kP.test(n);
  if (o && KP(e, n), !(r || o))
...
i(JP, "postInitInputChangeError");
function XP(e, t, n) {
  n.forEach((r) => {
    if (t.hasOwnProperty(r) && !t[r].isFirstChange())
      throw r === "ngSrc" && (e = { ngSrc: t[r].previousValue }), JP(e, r);
  });
}
i(XP, "assertNoPostInitInputChange");
function Vm(e, t, n) {
...
i(tx, "assertNonEmptyWidthAndHeight");
function nx(e) {
  if (e.width || e.height)
...
i(nx, "assertEmptyWidthAndHeight");
function rx(e, t, n) {
  const r = n.listen(t, "load", () => {
    r(), o();
...
i(rx, "assertNonZeroRenderedHeight");
function ox(e) {
...
i(ix, "assertNotMissingBuiltInLoader");
function sx(e, t) {
...
var ux = Object.getOwnPropertyDescriptor, cx = /* @__PURE__ */ i((e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? ux(t, n) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (o = a(o) || o);
  return o;
}, "__decorateClass");
let Um = class {
